...
INSERT INTO "armadura" VALUES
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Bandana de Tecido'), 'd4', 1, 5, 1, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Bandana de Tecido II'), 'd6', 2, 5, 2, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Bandana de Tecido III'), 'd6', 3, 10, 3, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Bandana de Tecido IV'), 'd8', 4, 15, 4, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Tecido'), 'd4', 1, 5, 1, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Tecido II'), 'd6', 2, 5, 2, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Tecido III'), 'd6', 3, 10, 3, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Tecido IV'), 'd8', 4, 15, 4, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Tecido'), 'd6', 2, 10, 2, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Tecido II'), 'd8', 3, 10, 3, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Tecido III'), 'd8', 4, 15, 4, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Tecido IV'), 'd10', 5, 20, 5, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Ferro'), 'd6', 2, 5, 2, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Ferro II'), 'd6', 3, 10, 3, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Ferro III'), 'd8', 4, 10, 4, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Ferro IV'), 'd10', 5, 15, 5, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Ferro'), 'd8', 3, 10, 3, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Ferro II'), 'd8', 4, 15, 4, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Ferro III'), 'd10', 5, 15, 5, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Ferro IV'), 'd12', 6, 20, 6, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Ferro'), 'd6', 2, 5, 2, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Ferro II'), 'd6', 3, 10, 3, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Ferro III'), 'd8', 4, 10, 4, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Ferro IV'), 'd10', 5, 15, 5, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Aço'), 'd8', 3, 10, 3, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Aço II'), 'd10', 4, 10, 4, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Aço III'), 'd10', 5, 15, 5, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Botas de Aço IV'), 'd12', 6, 20, 6, 'Botas'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Aço'), 'd10', 4, 15, 4, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Aço II'), 'd10', 5, 15, 5, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Aço III'), 'd12', 6, 20, 6, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Peitoral de Aço IV'), 'd12', 7, 25, 7, 'Peitoral'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Aço'), 'd8', 3, 10, 3, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Aço II'), 'd10', 4, 10, 4, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Aço III'), 'd10', 5, 15, 5, 'Capacete'),
    ((SELECT "idItem" FROM "item" WHERE "nome" = 'Capacete de Aço IV'), 'd12', 6, 20, 6, 'Capacete');
