...
INSERT INTO "lojaNPC" ("nome", "tipoLoja", "descricao", "status", "idNPC", "idMapa")
    ...
    (
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Andrei'),
        1 
    ),
    (
        'O Chapéu de Madeira',
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Eris'),
        1 
    ),
    (
        'Le Retailer',
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Juliette'), 
        1 
    ),
    (
        'Banco de Rynoka',
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Edward'), 
        1 
    ),
    (
        'Tenda da Bruxa',
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Bruxa dos Murmúrios'), 
        1 
    ),
    (
        'Barraca do Tom',
        ...
        TRUE,
        (SELECT "idNPC" FROM "npc" WHERE "nome" = 'Tom'), 
        1 
    );
